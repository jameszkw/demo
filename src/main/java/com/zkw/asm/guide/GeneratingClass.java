...
public class GeneratingClass {
	private void gen(){
		...
		cw.visit(Opcodes.V1_5,  Opcodes.ACC_PUBLIC +Opcodes.ACC_ABSTRACT + Opcodes.ACC_INTERFACE, "/com/zkw/asm/guide/Comparable", null, "java/lang/Object", new String[] {"/com/zkw/asm/guide/A"});
